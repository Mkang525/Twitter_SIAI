...
print('\nclean_column_names(df) function ready for use.\n',
        '\tThe clean_colomn_names(df) function will make all column names lower-case and will replace all\n',
        '\tspecial characters with an _ .')
